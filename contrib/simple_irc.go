...
func main() {
	...
	ircEnable, _ := os.LookupEnv("ZOOM_NOTIFIER_IRC_ENABLE")
	var (
		ircServer   string
		ircChannel  string
		ircNick     string
	...
	if ircEnable == "true" {
		...
		validateEnvVars("ZOOM_NOTIFIER_IRC_SERVER")
		validateEnvVars("ZOOM_NOTIFIER_IRC_CHANNEL")
		validateEnvVars("ZOOM_NOTIFIER_IRC_NICK")
		validateEnvVars("ZOOM_NOTIFIER_IRC_PASS")

		ircServer, _ = os.LookupEnv("ZOOM_NOTIFIER_IRC_SERVER")
		ircChannel, _ = os.LookupEnv("ZOOM_NOTIFIER_IRC_CHANNEL")
		ircNick, _ = os.LookupEnv("ZOOM_NOTIFIER_IRC_NICK")
		ircPassword, _ = os.LookupEnv("ZOOM_NOTIFIER_IRC_PASS")
	}
