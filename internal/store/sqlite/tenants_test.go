...
func TestGetTenantByZoomAccount(t *testing.T) {
	...
	if err := s.CreateTenant(ctx, &store.Tenant{ID: "T1", APIKey: "k1", ZoomAccountID: "zoom-1"}); err != nil {
		t.Fatal(err)
	}
	if err := s.CreateTenant(ctx, &store.Tenant{ID: "T2", APIKey: "k2", ZoomAccountID: "zoom-1"}); err != nil {
		t.Fatal(err)
	}
	if err := s.CreateTenant(ctx, &store.Tenant{ID: "T3", APIKey: "k3", ZoomAccountID: "zoom-2"}); err != nil {
		t.Fatal(err)
	}
...
func TestDeleteTenant(t *testing.T) {
	...
	if err := s.CreateTenant(ctx, &store.Tenant{ID: "T1", APIKey: "k1"}); err != nil {
		t.Fatal(err)
	}
...
func TestListTenants(t *testing.T) {
	...
	if err := s.CreateTenant(ctx, &store.Tenant{ID: "T2", APIKey: "k2"}); err != nil {
		t.Fatal(err)
	}
...
func TestUpdateTenantDefaults(t *testing.T) {
	...
	if err := s.CreateTenant(ctx, &store.Tenant{ID: "T1", APIKey: "k1", DefaultMsgSuffix: "", DefaultIncludeLink: false}); err != nil {
		t.Fatal(err)
	}
...
func TestUpdateTenantAPIKey(t *testing.T) {
	...
	if err := s.CreateTenant(ctx, &store.Tenant{ID: "T1", APIKey: "old-key"}); err != nil {
		t.Fatal(err)
	}
